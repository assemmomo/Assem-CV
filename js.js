...
function colorchange(){
    ...
    card.style.background="linear-gradient(to bottom left ,#153448,#224d69)";
    comment.classList.add("lightColor");
    firstName.classList.add("lightColor");
    lastName.classList.add("lightColor");
    submitBtn.classList.add("lightColor");
    email.classList.add("lightColor");
    comment.classList.t("darkColor");
    firstName.classList.remove("darkColor");
    lastName.classList.remove("darkColor");
    submitBtn.classList.remove("darkColor");
    email.classList.remove("darkColor");
}
...
function colorchange4(){
    window.localStorage.setItem("color","#151515");
    // colorCh.forEach( element =>{
    ...
    card.style.background="linear-gradient(to bottom left ,#d4d4d4,#151515)";
    comment.classList.add("darkColor");
    firstName.classList.add("darkColor");
    lastName.classList.add("darkColor");
    submitBtn.classList.add("darkColor");
    email.classList.add("darkColor");
    comment.classList.remove("lightColor");
    firstName.classList.remove("lightColor");
    lastName.classList.remove("lightColor");
    submitBtn.classList.remove("lightColor");
    email.classList.remove("lightColor");
}
...
document.getElementById('goRight').addEventListener('click', function() {
    currentProject = (currentProject % 7) + 1; // التبديل بين 1 و 2 و 3 و 4 بشكل دوري
    showProject(currentProject);
});

// التحقق من الضغط على السهم الأيسر
document.getElementById('goLeft').addEventListener('click', function() {
    currentProject = (currentProject - 2 + 7) % 7 + 1; // التبديل بين 3 و 2 و 1 بشكل دوري
    showProject(currentProject);
});
...
setInterval(function(){
    if(pro1.style.display=="block"){
        ...
        count7.classList.remove("activePro");
        ...
        count4.classList.remove("activePro");
        count5.classList.remove("activePro");
        count6.classList.add("activePro");
        count7.classList.remove("activePro");
    }
    else if(pro7.style.display=="block"){
        count1.classList.remove("activePro");
        count2.classList.remove("activePro");
        count3.classList.remove("activePro");
        count4.classList.remove("activePro");
        count5.classList.remove("activePro");
        count6.classList.remove("activePro");
        count7.classList.add("activePro");
    }
},100)
...
//         console.log("yes");
//     }
//     console.log(`your nam is:${a} , your age is :${b}, your country is : ${c}`)
